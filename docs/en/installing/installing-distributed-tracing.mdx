...
Follow the instructions in the <ExternalSiteLink name="opentelemetry" href="/installing/install-opentelemetry/install-opentelemetry.html#installing-via-the-web-console" children="Installing via the web console" /> section of the Alauda Build of OpenTelemetry v2 documentation.

### Installing via the CLI

Follow the instructions in the <ExternalSiteLink name="opentelemetry" href="/installing/install-opentelemetry/install-opentelemetry.html#installing-via-the-cli" children="Installing via the CLI" /> section of the Alauda Build of OpenTelemetry v2 documentation.
