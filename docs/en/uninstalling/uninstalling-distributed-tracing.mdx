...
For more details, see <ExternalSiteLink name="opentelemetry" href="/uninstalling/uninstalling-opentelemetry/uninstalling-opentelemetry.html" children="Uninstalling Alauda Build of OpenTelemetry v2" />.
