...
1. Confirm that both `OpenTelemetryCollector` resources are healthy:
    ...
    cpaas-system    otel     deployment   0.158.0   1/1     5h    build-harbor.alauda.cn/asm/opentelemetry-collector:0.158.0-r0   managed
    jaeger-system   jaeger   deployment   0.158.0   1/1     33m   build-harbor.alauda.cn/asm/jaeger:2.20.0-r0                     managed
    ```
